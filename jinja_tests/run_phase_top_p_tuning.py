#!/usr/bin/env python3
"""
Phase 8b Iteration 5: Top-P Parameter Tuning (v2.4)
Unified test runner for Phases 5, 6, and 6.5
Tests top_p 0.9 + temperature 0.3 (vs v2.2's top_p 0.8).
...
# Test output directory (Phase 6.5 top_p)
TEST_DIR = Path("C:\\LLM\\test_results\\phase6_5_top_p")
...
def tc3_write_file():
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "user",
                "content": 'Write "top_p test v2.4" to C:\\LLM\\test_results\\phase6_5_top_p\\test_v2_4.txt'
            }
        ],
        "tools": load_tools_schema(),
        "temperature": 0.3,
...
def tc8_complex_workflow():
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "user",
                "content": "List templates dir, search for v2.4, then read that template file"
            }
        ],
        "tools": load_tools_schema(),
        "temperature": 0.3,
...
def test_read_and_write():
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Read C:\\LLM\\jinja_templates\\chat_template_cline_optimized_v2.4.jinja"
            }
        ],
        "tools": load_tools_schema(),
        "temperature": 0.3,
...
def run_all_tests():
    """Run all test phases."""
    print("\n" + "=" * 70)
    print("Phase 8b Iteration 5: Top-P Tuning (v2.4)")
    print("Comprehensive Test Suite")
    print("=" * 70)

    all_results = {
        "test_name": "Phase 8b Iteration 5: Top-P Parameter Tuning (v2.4)",
    ...
    # Save to JSON
    results_file = TEST_DIR / "Phase6-5-Top-P-Results.json"
