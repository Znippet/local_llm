param(
    [ValidateSet("v1.0", "v2.0", "v2.1", "v2.2", "v2.3")]
    [string]$Version = "v1.0",
...
.PARAMETER Version
Template-Version zu deployen: v1.0 (File Ops), v2.0 (Extended Tools), v2.1 (Tool Sequencing), v2.2 (Temperature Tuning), or v2.3 (Min-P Testing)
